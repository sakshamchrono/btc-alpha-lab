...
def run_backtest_5m(csv_file):
    ...
    print(f"[5m IST Blockout] Python Validation - Trades: {total_trades} | Win Rate: {win_rate:.2f}% | PnL: ${total_pnl:.2f}")

run_backtest_5m('xauusd_5m_30days.csv')
