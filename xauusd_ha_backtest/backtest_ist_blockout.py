...
def run_backtest_3m(csv_file):
    ...
    print(f"[3m IST Blockout] Python Validation - Trades: {total_trades} | Win Rate: {win_rate:.2f}% | PnL: ${total_pnl:.2f}")

run_backtest_3m('xauusd_3m_30days.csv')
