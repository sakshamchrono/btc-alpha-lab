...
def run_backtest_15m(csv_file):
    ...
    print(f"[15m IST Blockout] Python Validation - Trades: {total_trades} | Win Rate: {win_rate:.2f}% | PnL: ${total_pnl:.2f}")

run_backtest_15m('xauusd_15m_30days.csv')
