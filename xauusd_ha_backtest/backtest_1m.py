...
def run_backtest_1m(csv_file):
    ...
    print(f"[1m IST Blockout] Python Validation - Trades: {total_trades} | Win Rate: {win_rate:.2f}% | PnL: ${total_pnl:.2f}")

run_backtest_1m('xauusd_1m_30days.csv')
